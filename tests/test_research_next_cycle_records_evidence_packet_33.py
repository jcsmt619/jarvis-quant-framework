...
from core.research_next_cycle_records_evidence_packet_33 import (
    BLOCKED_BY_SAFETY_GATE,
    ResearchNextCycleRecordsEvidencePacket33Input,
    RECORDS_EVIDENCE_PACKET_33_READY_FOR_HUMAN_REVIEW,
    build_default_research_next_cycle_records_evidence_packet_33_input,
    build_research_next_cycle_records_evidence_packet_33_payload,
    render_research_next_cycle_records_evidence_packet_33_markdown,
    write_research_next_cycle_records_evidence_packet_33,
)
...
def _root() -> Path:
    return Path("reports/research_next_cycle_records_evidence_packet_33_tests") / uuid.uuid4().hex
...
def _gate_input(root: Path) -> ResearchNextCycleRecordsEvidencePacket33Input:
    return ResearchNextCycleRecordsEvidencePacket33Input(
        records_evidence_packet_33_id="33B-RESEARCH-NEXT-CYCLE-RECORDS-EVIDENCE-PACKET-33-2026-07-07",
        records_evidence_packet_33_date="2026-07-07",
        generated_at_utc=FIXED_NOW.isoformat(),
        records_review_gate_33_path=root
        / "research_next_cycle_records_review_gate_33"
        / "research_next_cycle_records_review_gate_33.json",
        records_evidence_packet_32_path=root
        / "research_next_cycle_records_evidence_packet_32"
        / "research_next_cycle_records_evidence_packet_32.json",
        records_review_gate_32_path=root
        / "research_next_cycle_records_review_gate_32"
        / "research_next_cycle_records_review_gate_32.json",
        records_evidence_packet_31_path=root
        / "research_next_cycle_records_evidence_packet_31"
        / "research_next_cycle_records_evidence_packet_31.json",
        records_review_gate_31_path=root
        / "research_next_cycle_records_review_gate_31"
        / "research_next_cycle_records_review_gate_31.json",
...
def _write_ready_inputs(root: Path) -> ResearchNextCycleRecordsEvidencePacket33Input:
    gate_input = _gate_input(root)
    payloads = {
        gate_input.records_review_gate_33_path: {
            **_artifact_payload("33A", "Next Cycle Records Review Gate 33", "records_review_gate_33_date"),
            "records_review_gate_33_state": "RECORDS_REVIEW_GATE_33_READY_FOR_HUMAN_REVIEW",
        },
        gate_input.records_evidence_packet_32_path: {
            **_artifact_payload("32B", "Next Cycle Records Evidence Packet 32", "records_evidence_packet_32_date"),
            "records_evidence_packet_32_state": "RECORDS_EVIDENCE_PACKET_32_READY_FOR_HUMAN_REVIEW",
        },
        gate_input.records_review_gate_32_path: {
            **_artifact_payload("32A", "Next Cycle Records Review Gate 32", "records_review_gate_32_date"),
            "records_review_gate_32_state": "RECORDS_REVIEW_GATE_32_READY_FOR_HUMAN_REVIEW",
        },
        gate_input.records_evidence_packet_31_path: {
            **_artifact_payload("31B", "Next Cycle Records Evidence Packet 31", "records_evidence_packet_31_date"),
            "records_evidence_packet_31_state": "RECORDS_EVIDENCE_PACKET_31_READY_FOR_HUMAN_REVIEW",
        },
        gate_input.records_review_gate_31_path: {
            **_artifact_payload("31A", "Next Cycle Records Review Gate 31", "records_review_gate_31_date"),
            "records_review_gate_31_state": "RECORDS_REVIEW_GATE_31_READY_FOR_HUMAN_REVIEW",
        },
        gate_input.frozen_start_evidence_packet_path: {
            **_artifact_payload("30B", "Next Cycle Frozen Start Evidence Packet", "frozen_start_evidence_packet_date"),
            ...
            "inert_command_hints": [
                {
                    "hint_id": "30B-HINT-33B",
                    "label": HUMAN_REVIEW_REQUIRED,
                    "summary": "Review records gate.",
                    "command_hint": "python scripts/run_research_next_cycle_records_evidence_packet_33.py",
                    "would_run": False,
                    "executed": False,
                }
            ],
    ...
    _write_json(
        ...
        [
            {
                "phase": "33B",
                "title": "Next Cycle Records Evidence Packet 33",
                "spec": "Build deterministic Records Evidence Packet 33 records.",
            },
        ],
    )
    return gate_input
...
def test_33B_builds_deterministic_records_evidence_packet_33() -> None:
    root = _root()
    try:
        gate_input = _write_ready_inputs(root)

        first = build_research_next_cycle_records_evidence_packet_33_payload(gate_input)
        second = build_research_next_cycle_records_evidence_packet_33_payload(gate_input)

        assert first == second
        assert first["phase"] == "33B"
        assert first["workflow"] == "Next Cycle Records Evidence Packet 33"
        assert first["records_evidence_packet_33_state"] == RECORDS_EVIDENCE_PACKET_33_READY_FOR_HUMAN_REVIEW
        assert first["records_review_gate_33_state"] == "RECORDS_REVIEW_GATE_33_READY_FOR_HUMAN_REVIEW"
        assert first["records_evidence_packet_32_state"] == "RECORDS_EVIDENCE_PACKET_32_READY_FOR_HUMAN_REVIEW"
        assert first["records_review_gate_32_state"] == "RECORDS_REVIEW_GATE_32_READY_FOR_HUMAN_REVIEW"
        assert first["records_evidence_state"] == "RECORDS_EVIDENCE_PACKET_31_READY_FOR_HUMAN_REVIEW"
        assert first["records_review_state"] == "RECORDS_REVIEW_GATE_31_READY_FOR_HUMAN_REVIEW"
        ...
        assert first["summary"]["source_artifact_count"] == 15
        ...
        assert first["summary"]["evidence_reference_count"] == 17
        assert first["queue_next_phase"]["phase"] == "33B"
...
def test_33B_writes_json_and_markdown_gate_33() -> None:
    root = _root()
    out_dir = root / "out"
    try:
        json_path, markdown_path = write_research_next_cycle_records_evidence_packet_33(
        ...
        assert json_path.name == "research_next_cycle_records_evidence_packet_33.json"
        assert markdown_path.name == "research_next_cycle_records_evidence_packet_33.md"
        assert payload["records_evidence_packet_33_id"] == "33B-RESEARCH-NEXT-CYCLE-RECORDS-EVIDENCE-PACKET-33-2026-07-07"
        assert "33B Next Cycle Records Evidence Packet 33" in markdown
        assert "Final Records Evidence Packet 33 Summary" in markdown
        assert "Records Review Gate 33 State" in markdown
        assert "Records Evidence Packet 32 State" in markdown
        assert "Records Review Gate 32 State" in markdown
        assert "Records Evidence State" in markdown
        assert "Records Review State" in markdown
...
def test_33B_classifies_blocked_for_missing_source_and_failed_safety_scanner() -> None:
    root = _root()
    try:
        gate_input = _write_ready_inputs(root)
        gate_input.records_evidence_packet_32_path.unlink()
        _write_json(
            gate_input.safety_scanner_path,
            {
                "workflow_id": "safety_scanner",
        ...
        markdown = render_research_next_cycle_records_evidence_packet_33_markdown(payload)

        assert payload["records_evidence_packet_33_state"] == BLOCKED_BY_SAFETY_GATE
        assert "records_evidence_packet_32" in {item["artifact_id"] for item in payload["missing_artifacts"]}
        assert "missing_records_evidence_packet_32" in {
...
def test_33B_rejects_secret_paths_unsafe_labels_and_execution_flags() -> None:
    root = _root()
    try:
        with pytest.raises(ValueError, match="secret files"):
            ResearchNextCycleRecordsEvidencePacket33Input(
                records_evidence_packet_33_id="33B-UNSAFE",
                records_evidence_packet_33_date="2026-07-07",
                generated_at_utc=FIXED_NOW.isoformat(),
        ...
        with pytest.raises(ValueError, match="unsafe|disallowed"):
            build_research_next_cycle_records_evidence_packet_33_payload(gate_input)
...
def test_33B_default_input_uses_phase_gate_id() -> None:
    gate_input = build_default_research_next_cycle_records_evidence_packet_33_input(now=FIXED_NOW)

    assert gate_input.records_evidence_packet_33_id == "33B-RESEARCH-NEXT-CYCLE-RECORDS-EVIDENCE-PACKET-33-2026-07-07"
    assert gate_input.records_evidence_packet_33_date == "2026-07-07"


def test_33B_cli_writes_next_cycle_records_evidence_packet_33() -> None:
    root = _root()
    out_dir = root / "out"
    try:
        gate_input = _write_ready_inputs(root)
        completed = subprocess.run(
            [
                sys.executable,
                "scripts/run_research_next_cycle_records_evidence_packet_33.py",
                "--out-dir",
                str(out_dir),
                "--records-evidence-packet-33-date",
                "2026-07-07",
                "--records-review-gate-33-path",
                str(gate_input.records_review_gate_33_path),
                "--records-evidence-packet-32-path",
                str(gate_input.records_evidence_packet_32_path),
                "--records-review-gate-32-path",
                str(gate_input.records_review_gate_32_path),
                "--records-evidence-packet-31-path",
                str(gate_input.records_evidence_packet_31_path),
                "--records-review-gate-31-path",
                str(gate_input.records_review_gate_31_path),
        ...
        assert "JARVIS 33B NEXT CYCLE RECORDS EVIDENCE PACKET 33: COMPLETE" in completed.stdout
        assert "Records Evidence Packet 33 is read-only and records-only" in completed.stdout
        ...
        assert "Records Evidence Packet 33 records do not grant execution permission" in completed.stdout
        assert "LIVE TRADING: DISABLED" in completed.stdout
        assert (out_dir / "research_next_cycle_records_evidence_packet_33.json").exists()
        assert (out_dir / "research_next_cycle_records_evidence_packet_33.md").exists()
    finally:
        shutil.rmtree(root, ignore_errors=True)
